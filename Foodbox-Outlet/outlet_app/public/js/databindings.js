...
//function checkEOD() {
//    console.log("checkEOD function called");
//    // // only check for eod if the outlet is non 24 hrs
...
//        automatic_eod_time_in_minutes_variation = automatic_eod_time_in_minutes + 5;
...
//}
    ...
    //function checkAutomaticEOD() {
    //    $.getJSON(HQ_URL + '/outlet/get_eod_status/' + OUTLET_ID)
    //      .done(function (data) {
    //          console.log('Received eod status data' + JSON.stringify(data));
    ...
    //              showEODDialog();
    //              $("#eod_confirm").trigger("click", [true]);
    //              $("#expiry_items_confirm").trigger("click");
    //              $("#orders .panel_header .stop_order").trigger("click");
    //              $("#unscanned_items_confirm").trigger("click");
    //              $("#loading_issue_confirm").trigger("click");              
    //          }
    //      })
    //      .fail(function (jqxhr, textStatus, error) {
    //          var err_msg = textStatus + ", " + jqxhr.responseText;
    //          console.error("getEODStatus :: Request Failed: " + err_msg);
    //      });
    //}
